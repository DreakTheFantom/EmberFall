package net.dreakthenfantom.emberfall.block;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(EmberFall.MOD_ID);

    public static final DeferredBlock<Block> BERYL_BLOCK = registerBlock("beryl_block",
            () -> new Block(BlockBehaviour.Properties.of()
                    .strength(3.0f).requiresCorrectToolForDrops().sound(SoundType.AMETHYST)));
